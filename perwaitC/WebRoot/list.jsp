<%@ page contentType="text/html" language="java" import="java.util.*,com.zsz.test.Names,java.sql.*,com.zsz.jdbc.*" pageEncoding="UTF-8"%>
	<%
...
<head>
<meta charset="UTF-8">
<title><%=new Dao().getXXval("theme", "tid", session_tid, "tname")+new Names().getListName()+new Names().getIndexName()+new Names().getIndexNameLast() %></title>
